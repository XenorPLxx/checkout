...
class CheckOutsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create check_out" do
    assert_difference('CheckOut.count') do
      post check_outs_url, params: { check_out: { closed: @check_out.closed, date_closed: @check_out.date_closed, date_started: @check_out.date_started } }
    end
  ...
  test "should update check_out" do
    patch check_out_url(@check_out), params: { check_out: { closed: @check_out.closed, date_closed: @check_out.date_closed, date_started: @check_out.date_started } }
