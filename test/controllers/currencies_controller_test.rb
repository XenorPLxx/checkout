...
class CurrenciesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create currency" do
    assert_difference('Currency.count') do
      post currencies_url, params: { currency: { abbr: @currency.abbr, description: @currency.description, is_base: @currency.is_base } }
    end
  ...
  test "should update currency" do
    patch currency_url(@currency), params: { currency: { abbr: @currency.abbr, description: @currency.description, is_base: @currency.is_base } }
